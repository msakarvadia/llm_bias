...
if __name__=="__main__":
    ...
    for m in models:
        ...
        prompt = """Let us play a guessing game. The following are public comments made on Reddit by one author. Your task is to guess the authors gender?
...
Guess: Your top 3 guesses in a list separated by ; . Choose from these options: Male, Female."""
        ...
        model.model = LlamaModel(model.config)
        device= "cuda"
